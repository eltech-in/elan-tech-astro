...
This article explains the architecture questions behind a custom Medusa.js subscription platform using Indian payment gateways and shipping workflows. It reflects lessons from our [Puritas Medusa.js implementation](https://puritas.in/) without exposing confidential code or merchant configuration.
