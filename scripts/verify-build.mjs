...
check('Plan: eLan Starter ₹20,000',            fileContains(LP, '20,000'));
check('Plan: eLan Business ₹26,000',           fileContains(LP, '26,000'));
check('Plan: eLan Complete ₹34,000',           fileContains(LP, '34,000'));
...
check('Step 5: Plan prices in strip',           fileContains(HP, '20,000', '26,000', '34,000'));
check('Step 6: AnnouncementBar island mounted', fileContains(HP, 'AnnouncementBar'));
